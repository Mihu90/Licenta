...
} TriggerRight_TDeviceData;            /* Device data structure type */

typedef TriggerRight_TDeviceData *TriggerRight_TDeviceDataPtr ; /* Pointer to the device data structure. */

/* {FreeRTOS RTOS Adapter} Static object used for simulation of dynamic driver memory allocation */
static TriggerRight_TDeviceData DeviceDataPrv__DEFAULT_RTOS_ALLOC;
/*
** ===================================================================
...
LDD_TDeviceData* TriggerRight_Init(LDD_TUserData *UserDataPtr)
{
  ...
  TriggerRight_TDeviceDataPtr DeviceDataPrv;
  ...
  PE_LDD_RegisterDeviceStructure(PE_LDD_COMPONENT_TriggerRight_ID,DeviceDataPrv);
...
bool TriggerRight_GetVal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  PortData = GPIO_PDD_GetPortDataOutput(TriggerRight_MODULE_BASE_ADDRESS) & TriggerRight_PORT_MASK;
...
void TriggerRight_PutVal(LDD_TDeviceData *DeviceDataPtr, bool Val)
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  if (Val) {
    GPIO_PDD_SetPortDataOutputMask(TriggerRight_MODULE_BASE_ADDRESS, TriggerRight_PORT_MASK);
  } else { /* !Val */
    GPIO_PDD_ClearPortDataOutputMask(TriggerRight_MODULE_BASE_ADDRESS, TriggerRight_PORT_MASK);
  } /* !Val */
}
