...
#define configMINIMAL_STACK_SIZE                  ((unsigned portSHORT)50) /* stack size in addressable stack units */
/*----------------------------------------------------------*/
/* Heap Memory */
#define configFRTOS_MEMORY_SCHEME                 2 /* either 1 (only alloc), 2 (alloc/free), 3 (malloc) or 4 (coalesc blocks) */
#define configTOTAL_HEAP_SIZE                     ((size_t)(4096)) /* size of heap in bytes */
...
#endif
/*----------------------------------------------------------*/
#define configMAX_TASK_NAME_LEN                   4 /* task name length */
