...
#define OS_PARSE_COMMAND_ENABLED  0 /* set to 1 if method ParseCommand() is present, 0 otherwise */
...
#define PEX_RTOS_START()               OS_vTaskStartScheduler()
...
#define OS_xTaskCreate(pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, pvCreatedTask) \
...
#define OS_taskDISABLE_INTERRUPTS() \
...
#define OS_taskENABLE_INTERRUPTS() \
...
#define OS_vTaskDelay(xTicksToDelay) \
...
#define OS_vTaskDelayUntil(pxPreviousWakeTime, xTimeIncrement) \
...
#define OS_uxTaskPriorityGet(pxTask) \
...
#define OS_vTaskPrioritySet(pxTask, uxNewPriority) \
...
#define OS_xSemaphoreTakeRecursive(xMutex, xBlockTime) \
...
#define OS_xSemaphoreGiveRecursive(xMutex) \
...
#define OS_xSemaphoreCreateRecursiveMutex() \
  xSemaphoreCreateRecursiveMutex()
...
#define OS_vTaskSuspend(pxTaskToSuspend) \
...
#define OS_vTaskResume(pxTaskToResume) \
...
#define OS_xSemaphoreCreateMutex() \
  xSemaphoreCreateMutex()
...
#define OS_xSemaphoreTake(xMutex, xBlockTime) \
...
#define OS_xSemaphoreGive(xMutex) \
...
#define OS_vSemaphoreCreateBinary(xSemaphore) \
...
#define OS_xSemaphoreCreateCounting(uxMaxCount, uxInitialCount) \
...
#define OS_xSemaphoreGiveFromISR(xSemaphore, pxHigherPriorityTaskWoken) \
...
#define OS_vSemaphoreDelete(xSemaphore) \
...
#define OS_pvPortMalloc(xWantedSize) \
...
#define OS_xTaskGetSchedulerState() \
...
#define OS_uxTaskGetStackHighWaterMark(xTask) \
...
#define OS_uxTaskGetNumberOfTasks() \
...
#define OS_xPortGetFreeHeapSize() \
...
#define OS_xQueueCreate(uxQueueLength, uxItemSize) \
...
#define OS_xQueueSendToFront(xQueue, pvItemToQueue, xTicksToWait) \
...
#define OS_xQueueSendToBack(xQueue, pvItemToQueue, xTicksToWait) \
...
#define OS_xQueueReceive(xQueue, pvBuffer, xTicksToWait) \
...
#define OS_xQueuePeek(xQueue, pvBuffer, xTicksToWait) \
...
#define OS_vQueueDelete(pxQueueToDelete) \
...
#define OS_uxQueueMessagesWaiting(xQueue) \
...
#define OS_uxQueueMessagesWaitingfromISR(xQueue) \
...
#define OS_xQueueReceiveFromISR(xQueue, pvBuffer, pxHigherPriorityTaskWoken) \
...
#define OS_xQueueSendToFrontFromISR(xQueue, pvItemToQueue, pxHigherPriorityTaskWoken) \
...
#define OS_xQueueSendToBackFromISR(xQueue, pvItemToQueue,pxHigherPriorityTaskWoken) \
...
#define OS_xTaskResumeFromISR(pxTaskToResume) \
...
#define OS_xSemaphoreGetMutexHolder(xSemaphore) \
...
#define OS_xSemaphoreTakeFromISR(xSemaphore, pxHigherPriorityTaskWoken) \
...
#define OS_xTaskGetTickCountFromISR() \
...
#define OS_xQueuePeekFromISR(xQueue, pvBuffer, xTicksToWait) \
...
#define OS_xQueueOverwrite(xQueue, pvItemToQueue) \
...
#define OS_xQueueOverwriteFromISR(xQueue, pvItemToQueue, pxHigherPriorityTaskWoken) \
...
#define OS_vQueueAddToRegistry(xQueue, pcQueueName) \
...
#define OS_vQueueUnregisterQueue(xQueue) \
...
#define OS_xQueueIsQueueFullFromISR(xQueue) \
...
#define OS_xQueueIsQueueEmptyFromISR(xQueue) \
...
#define OS_xEventGroupWaitBits(xEventGroup, uxBitsToWaitFor, xClearOnExit, xWaitForAllBits, xTicksToWait) \
...
#define OS_xEventGroupSetBits(xEventGroup, uxBitsToSet) \
...
#define OS_xEventGroupSetBitsFromISR(xEventGroup, uxBitsToSet, pxHigherPriorityTaskWoken) \
...
#define OS_xEventGroupClearBits(xEventGroup, uxBitsToSet) \
...
#define OS_xEventGroupClearBitsFromISR(xEventGroup, uxBitsToSet) \
...
#define OS_xEventGroupGetBits(xEventGroup) \
...
#define OS_xEventGroupGetBitsFromISR(xEventGroup) \
...
#define OS_xEventGroupSync(xEventGroup, uxBitsToSet, uxBitsToWaitFor, xTicksToWait) \
