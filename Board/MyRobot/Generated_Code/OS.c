...
**            Task Name Length                             : 4
**            Minimal Stack Size                           : 50
**            Maximum Priorities                           : 3
...
**            Total Heap Size                              : 4096
**          Shell                                          : Disabled
**          Utility                                        : Utility
**     Contents    :
**         xTaskCreate                    - portBASE_TYPE OS_xTaskCreate(pdTASK_CODE pvTaskCode, const portCHAR * const...
**         vTaskDelete                    - void OS_vTaskDelete(xTaskHandle pxTask);
**         vTaskStartScheduler            - void OS_vTaskStartScheduler(void);
**         vTaskEndScheduler              - void OS_vTaskEndScheduler(void);
**         vTaskSuspend                   - void OS_vTaskSuspend(xTaskHandle pxTaskToSuspend);
**         vTaskSuspendAll                - void OS_vTaskSuspendAll(void);
**         vTaskResume                    - void OS_vTaskResume(xTaskHandle pxTaskToResume);
**         xTaskResumeAll                 - portBASE_TYPE OS_xTaskResumeAll(void);
**         xTaskResumeFromISR             - portBASE_TYPE OS_xTaskResumeFromISR(xTaskHandle pxTaskToResume);
**         taskYIELD                      - void OS_taskYIELD(void);
**         taskENTER_CRITICAL             - void OS_taskENTER_CRITICAL(void);
**         taskEXIT_CRITICAL              - void OS_taskEXIT_CRITICAL(void);
**         taskDISABLE_INTERRUPTS         - void OS_taskDISABLE_INTERRUPTS(void);
**         taskENABLE_INTERRUPTS          - void OS_taskENABLE_INTERRUPTS(void);
**         vTaskDelay                     - void OS_vTaskDelay(portTickType xTicksToDelay);
**         vTaskDelayUntil                - void OS_vTaskDelayUntil(portTickType *pxPreviousWakeTime, portTickType...
**         uxTaskPriorityGet              - unsigned_portBASE_TYPE OS_uxTaskPriorityGet(xTaskHandle pxTask);
**         vTaskPrioritySet               - void OS_vTaskPrioritySet(xTaskHandle pxTask, unsigned_portBASE_TYPE...
**         xTaskGetTickCount              - portTickType OS_xTaskGetTickCount(void);
**         xTaskGetTickCountFromISR       - portTickType OS_xTaskGetTickCountFromISR(void);
**         xSemaphoreCreateRecursiveMutex - xSemaphoreHandle OS_xSemaphoreCreateRecursiveMutex(void);
**         xSemaphoreTakeRecursive        - bool OS_xSemaphoreTakeRecursive(xSemaphoreHandle xMutex, portTickType...
**         xSemaphoreGiveRecursive        - bool OS_xSemaphoreGiveRecursive(xSemaphoreHandle xMutex);
**         xSemaphoreCreateMutex          - xSemaphoreHandle OS_xSemaphoreCreateMutex(void);
**         xSemaphoreTake                 - bool OS_xSemaphoreTake(xSemaphoreHandle xMutex, portTickType xBlockTime);
**         xSemaphoreGive                 - bool OS_xSemaphoreGive(xSemaphoreHandle xMutex);
**         vSemaphoreCreateBinary         - void OS_vSemaphoreCreateBinary(xSemaphoreHandle xSemaphore);
**         xSemaphoreCreateCounting       - xSemaphoreHandle OS_xSemaphoreCreateCounting(unsigned_portBASE_TYPE...
**         xSemaphoreGiveFromISR          - bool OS_xSemaphoreGiveFromISR(xSemaphoreHandle xSemaphore,...
**         xSemaphoreTakeFromISR          - bool OS_xSemaphoreTakeFromISR(xSemaphoreHandle xSemaphore,...
**         vSemaphoreDelete               - void OS_vSemaphoreDelete(xSemaphoreHandle xSemaphore);
**         xSemaphoreGetMutexHolder       - void* OS_xSemaphoreGetMutexHolder(xSemaphoreHandle xSemaphore);
**         pvPortMalloc                   - pVoid OS_pvPortMalloc(size_t xWantedSize);
**         vPortFree                      - void OS_vPortFree(void *pv);
**         xPortGetFreeHeapSize           - Tsize_t OS_xPortGetFreeHeapSize(void);
**         xTaskGetSchedulerState         - portBASE_TYPE OS_xTaskGetSchedulerState(void);
**         uxTaskGetStackHighWaterMark    - unsigned_portBASE_TYPE OS_uxTaskGetStackHighWaterMark(xTaskHandle xTask);
**         uxTaskGetNumberOfTasks         - unsigned_portBASE_TYPE OS_uxTaskGetNumberOfTasks(void);
**         uxQueueMessagesWaiting         - unsigned_portBASE_TYPE OS_uxQueueMessagesWaiting(xQueueHandle xQueue);
**         uxQueueMessagesWaitingfromISR  - unsigned_portBASE_TYPE OS_uxQueueMessagesWaitingfromISR(xQueueHandle xQueue);
**         xQueueCreate                   - xQueueHandle OS_xQueueCreate(unsigned_portBASE_TYPE uxQueueLength,...
**         vQueueDelete                   - void OS_vQueueDelete(xQueueHandle pxQueueToDelete);
**         xQueueReset                    - portBASE_TYPE OS_xQueueReset(xQueueHandle xQueue);
**         xQueueSendToBack               - portBASE_TYPE OS_xQueueSendToBack(xQueueHandle xQueue, const void...
**         xQueueSendToFront              - portBASE_TYPE OS_xQueueSendToFront(xQueueHandle xQueue, const void...
**         xQueueReceive                  - portBASE_TYPE OS_xQueueReceive(xQueueHandle xQueue, void *pvBuffer,...
**         xQueueOverwrite                - portBASE_TYPE OS_xQueueOverwrite(xQueueHandle xQueue, const void...
**         xQueueOverwriteFromISR         - portBASE_TYPE OS_xQueueOverwriteFromISR(xQueueHandle xQueue, const void...
**         xQueuePeek                     - portBASE_TYPE OS_xQueuePeek(xQueueHandle xQueue, void *pvBuffer, portTickType...
**         xQueuePeekFromISR              - portBASE_TYPE OS_xQueuePeekFromISR(xQueueHandle xQueue, void *pvBuffer,...
**         xQueueSendToBackFromISR        - portBASE_TYPE OS_xQueueSendToBackFromISR(xQueueHandle xQueue, const void...
**         xQueueSendToFrontFromISR       - portBASE_TYPE OS_xQueueSendToFrontFromISR(xQueueHandle xQueue, const void...
**         xQueueReceiveFromISR           - portBASE_TYPE OS_xQueueReceiveFromISR(xQueueHandle xQueue, void *pvBuffer,...
**         vQueueAddToRegistry            - void OS_vQueueAddToRegistry(xQueueHandle xQueue, char *pcQueueName);
**         vQueueUnregisterQueue          - void OS_vQueueUnregisterQueue(xQueueHandle xQueue);
**         xQueueIsQueueFullFromISR       - portBASE_TYPE OS_xQueueIsQueueFullFromISR(xQueueHandle xQueue);
**         xQueueIsQueueEmptyFromISR      - portBASE_TYPE OS_xQueueIsQueueEmptyFromISR(xQueueHandle xQueue);
**         xEventGroupCreate              - EventGroupHandle_t OS_xEventGroupCreate(void);
**         xEventGroupWaitBits            - byte OS_xEventGroupWaitBits(const EventGroupHandle_t xEventGroup, const...
**         xEventGroupSetBits             - EventBits_t OS_xEventGroupSetBits(EventGroupHandle_t xEventGroup, const...
**         xEventGroupSetBitsFromISR      - EventBits_t OS_xEventGroupSetBitsFromISR(EventGroupHandle_t xEventGroup,...
**         xEventGroupClearBits           - EventBits_t OS_xEventGroupClearBits(EventGroupHandle_t xEventGroup, const...
**         xEventGroupClearBitsFromISR    - EventBits_t OS_xEventGroupClearBitsFromISR(EventGroupHandle_t xEventGroup,...
**         xEventGroupGetBits             - EventBits_t OS_xEventGroupGetBits(EventGroupHandle_t xEventGroup);
**         xEventGroupGetBitsFromISR      - EventBits_t OS_xEventGroupGetBitsFromISR(EventGroupHandle_t xEventGroup);
**         xEventGroupSync                - EventBits_t OS_xEventGroupSync(EventGroupHandle_t xEventGroup, const...
**         Init                           - void OS_Init(void);
**
...
*/         
/*!
**  @addtogroup OS_module OS module documentation
**  @{
*/         
...
/*
** ===================================================================
**     Method      :  OS_xTaskCreate (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xTaskCreate(pdTASK_CODE pvTaskCode, const portCHAR * const pcName, unsigned portSHORT usStackDepth, void *pvParameters, unsigned portBASE_TYPE uxPriority, xTaskHandle *pvCreatedTask)
{
  *** Implemented as macro in the header file OS.h
}
*/

/*
** ===================================================================
**     Method      :  OS_vTaskDelete (component FreeRTOS)
**     Description :
...
*/
/*
void OS_vTaskDelete(xTaskHandle pxTask)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_vTaskStartScheduler (component FreeRTOS)
**     Description :
...
*/
/*
void OS_vTaskStartScheduler(void)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_taskYIELD (component FreeRTOS)
**     Description :
...
/*
** ===================================================================
**     Method      :  OS_taskENTER_CRITICAL (component FreeRTOS)
**     Description :
...
/*
** ===================================================================
**     Method      :  OS_taskEXIT_CRITICAL (component FreeRTOS)
**     Description :
...
/*
** ===================================================================
**     Method      :  OS_taskDISABLE_INTERRUPTS (component FreeRTOS)
**     Description :
...
*/
/*
void OS_taskDISABLE_INTERRUPTS(void)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_taskENABLE_INTERRUPTS (component FreeRTOS)
**     Description :
...
*/
/*
void OS_taskENABLE_INTERRUPTS(void)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_vTaskEndScheduler (component FreeRTOS)
**     Description :
...
*/
/*
void OS_vTaskEndScheduler(void)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_vTaskSuspendAll (component FreeRTOS)
**     Description :
...
/*
** ===================================================================
**     Method      :  OS_xTaskResumeAll (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xTaskResumeAll(void)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xTaskResumeFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xTaskResumeFromISR(xTaskHandle pxTaskToResume)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_vTaskDelay (component FreeRTOS)
**     Description :
...
*/
/*
void OS_vTaskDelay(portTickType xTicksToDelay)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_vTaskDelayUntil (component FreeRTOS)
**     Description :
...
*/
/*
void OS_vTaskDelayUntil(portTickType *pxPreviousWakeTime, portTickType xTimeIncrement)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_uxTaskPriorityGet (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE OS_uxTaskPriorityGet(xTaskHandle pxTask)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_vTaskPrioritySet (component FreeRTOS)
**     Description :
...
*/
/*
void OS_vTaskPrioritySet(xTaskHandle pxTask, unsigned_portBASE_TYPE uxNewPriority)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xSemaphoreTakeRecursive (component FreeRTOS)
**     Description :
...
*/
/*
bool OS_xSemaphoreTakeRecursive(xSemaphoreHandle xMutex, portTickType xBlockTime)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xSemaphoreGiveRecursive (component FreeRTOS)
**     Description :
...
*/
/*
bool OS_xSemaphoreGiveRecursive(xSemaphoreHandle xMutex)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xSemaphoreCreateRecursiveMutex (component FreeRTOS)
**     Description :
...
*/
/*
xSemaphoreHandle OS_xSemaphoreCreateRecursiveMutex(void)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_vSemaphoreDelete (component FreeRTOS)
**     Description :
...
*/
/*
void OS_vSemaphoreDelete(xSemaphoreHandle xSemaphore)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_vTaskSuspend (component FreeRTOS)
**     Description :
...
*/
/*
void OS_vTaskSuspend(xTaskHandle pxTaskToSuspend)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_vTaskResume (component FreeRTOS)
**     Description :
...
*/
/*
void OS_vTaskResume(xTaskHandle pxTaskToResume)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xSemaphoreCreateMutex (component FreeRTOS)
**     Description :
...
*/
/*
xSemaphoreHandle OS_xSemaphoreCreateMutex(void)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xSemaphoreTake (component FreeRTOS)
**     Description :
...
*/
/*
bool OS_xSemaphoreTake(xSemaphoreHandle xMutex, portTickType xBlockTime)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xSemaphoreGive (component FreeRTOS)
**     Description :
...
*/
/*
bool OS_xSemaphoreGive(xSemaphoreHandle xMutex)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_vSemaphoreCreateBinary (component FreeRTOS)
**     Description :
...
*/
/*
void OS_vSemaphoreCreateBinary(xSemaphoreHandle xSemaphore)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xSemaphoreCreateCounting (component FreeRTOS)
**     Description :
...
*/
/*
xSemaphoreHandle OS_xSemaphoreCreateCounting(unsigned_portBASE_TYPE uxMaxCount, unsigned_portBASE_TYPE uxInitialCount)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xSemaphoreGiveFromISR (component FreeRTOS)
**     Description :
**         Macro to release a semaphore. The semaphore must have
**         previously been created with a call to
...
*/
/*
bool OS_xSemaphoreGiveFromISR(xSemaphoreHandle xSemaphore, signed_portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_pvPortMalloc (component FreeRTOS)
**     Description :
...
*/
/*
pVoid OS_pvPortMalloc(size_t xWantedSize)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_vPortFree (component FreeRTOS)
**     Description :
...
/*
** ===================================================================
**     Method      :  OS_xTaskGetTickCount (component FreeRTOS)
**     Description :
...
*/
/*
portTickType OS_xTaskGetTickCount(void)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xTaskGetSchedulerState (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xTaskGetSchedulerState(void)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_uxTaskGetStackHighWaterMark (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE OS_uxTaskGetStackHighWaterMark(xTaskHandle xTask)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_uxTaskGetNumberOfTasks (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE OS_uxTaskGetNumberOfTasks(void)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xPortGetFreeHeapSize (component FreeRTOS)
**     Description :
...
*/
/*
Tsize_t OS_xPortGetFreeHeapSize(void)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xQueueCreate (component FreeRTOS)
**     Description :
**         Creates a queue.
**     Parameters  :
**         NAME            - DESCRIPTION
...
*/
/*
xQueueHandle OS_xQueueCreate(unsigned_portBASE_TYPE uxQueueLength, unsigned_portBASE_TYPE uxItemSize)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xQueueSendToFront (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xQueueSendToFront(xQueueHandle xQueue, const void *pvItemToQueue, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xQueueSendToBack (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xQueueSendToBack(xQueueHandle xQueue, const void *pvItemToQueue, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xQueueReceive (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xQueueReceive(xQueueHandle xQueue, void *pvBuffer, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xQueuePeek (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xQueuePeek(xQueueHandle xQueue, void *pvBuffer, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_vQueueDelete (component FreeRTOS)
**     Description :
...
*/
/*
void OS_vQueueDelete(xQueueHandle pxQueueToDelete)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_uxQueueMessagesWaiting (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE OS_uxQueueMessagesWaiting(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_uxQueueMessagesWaitingfromISR (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE OS_uxQueueMessagesWaitingfromISR(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xQueueReceiveFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xQueueReceiveFromISR(xQueueHandle xQueue, void *pvBuffer, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xQueueSendToFrontFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xQueueSendToFrontFromISR(xQueueHandle xQueue, const void *pvItemToQueue, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xQueueSendToBackFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xQueueSendToBackFromISR(xQueueHandle xQueue, const void *pvItemToQueue, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file OS.h
}
*/
/*
** ===================================================================
**     Method      :  OS_xQueueReset (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xQueueReset(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xSemaphoreGetMutexHolder (component FreeRTOS)
**     Description :
...
*/
/*
void* OS_xSemaphoreGetMutexHolder(xSemaphoreHandle xSemaphore)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xSemaphoreTakeFromISR (component FreeRTOS)
**     Description :
...
*/
/*
bool OS_xSemaphoreTakeFromISR(xSemaphoreHandle xSemaphore, signed_portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_Init (component FreeRTOS)
**     Description :
...
/*
** ===================================================================
**     Method      :  OS_xTaskGetTickCountFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portTickType OS_xTaskGetTickCountFromISR(void)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xQueuePeekFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xQueuePeekFromISR(xQueueHandle xQueue, void *pvBuffer, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xQueueOverwrite (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xQueueOverwrite(xQueueHandle xQueue, const void *pvItemToQueue)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xQueueOverwriteFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xQueueOverwriteFromISR(xQueueHandle xQueue, const void *pvItemToQueue, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_vQueueAddToRegistry (component FreeRTOS)
**     Description :
...
*/
/*
void OS_vQueueAddToRegistry(xQueueHandle xQueue, char *pcQueueName)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_vQueueUnregisterQueue (component FreeRTOS)
**     Description :
...
*/
/*
void OS_vQueueUnregisterQueue(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xQueueIsQueueFullFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xQueueIsQueueFullFromISR(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xQueueIsQueueEmptyFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE OS_xQueueIsQueueEmptyFromISR(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xEventGroupCreate (component FreeRTOS)
**     Description :
...
*/
/*
EventGroupHandle_t OS_xEventGroupCreate(void)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xEventGroupWaitBits (component FreeRTOS)
**     Description :
...
*/
/*
byte OS_xEventGroupWaitBits(const EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToWaitFor, const BaseType_t xClearOnExit, const BaseType_t xWaitForAllBits, TickType_t xTicksToWait)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xEventGroupSetBits (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t OS_xEventGroupSetBits(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet )
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xEventGroupSetBitsFromISR (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t OS_xEventGroupSetBitsFromISR(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet , BaseType_t *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xEventGroupClearBits (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t OS_xEventGroupClearBits(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet )
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xEventGroupClearBitsFromISR (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t OS_xEventGroupClearBitsFromISR(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet )
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xEventGroupGetBits (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t OS_xEventGroupGetBits(EventGroupHandle_t xEventGroup)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xEventGroupGetBitsFromISR (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t OS_xEventGroupGetBitsFromISR(EventGroupHandle_t xEventGroup)
{
  *** Implemented as macro in the header file OS.h
}
*/
...
/*
** ===================================================================
**     Method      :  OS_xEventGroupSync (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t OS_xEventGroupSync(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet, const EventBits_t uxBitsToWaitFor, TickType_t xTicksToWait)
{
  *** Implemented as macro in the header file OS.h
}
*/
