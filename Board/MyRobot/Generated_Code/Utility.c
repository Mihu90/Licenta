...
**         strcat                  - void Utility_strcat(byte *dst, size_t dstSize, const unsigned char *src);
**         chcat                   - void Utility_chcat(byte *dst, size_t dstSize, byte ch);
**         Num8sToStr              - void Utility_Num8sToStr(uint8_t *dst, size_t dstSize, signed char val);
**         Num8uToStr              - void Utility_Num8uToStr(uint8_t *dst, size_t dstSize, uint8_t val);
**         Num16sToStr             - void Utility_Num16sToStr(uint8_t *dst, size_t dstSize, int16_t val);
**         Num16uToStr             - void Utility_Num16uToStr(uint8_t *dst, size_t dstSize, uint16_t val);
**         Num32uToStr             - void Utility_Num32uToStr(uint8_t *dst, size_t dstSize, uint32_t val);
**         Num32sToStr             - void Utility_Num32sToStr(uint8_t *dst, size_t dstSize, long val);
**         Num16sToStrFormatted    - void Utility_Num16sToStrFormatted(uint8_t *dst, size_t dstSize, int16_t val,...
**         Num16uToStrFormatted    - void Utility_Num16uToStrFormatted(uint8_t *dst, size_t dstSize, uint16_t val,...
**         Num32uToStrFormatted    - void Utility_Num32uToStrFormatted(uint8_t *dst, size_t dstSize, uint32_t val,...
**         Num32sToStrFormatted    - void Utility_Num32sToStrFormatted(uint8_t *dst, size_t dstSize, long val,...
**         strcatNum8u             - void Utility_strcatNum8u(uint8_t *dst, size_t dstSize, uint8_t val);
**         strcatNum8s             - void Utility_strcatNum8s(uint8_t *dst, size_t dstSize, signed char val);
**         strcatNum16u            - void Utility_strcatNum16u(uint8_t *dst, size_t dstSize, uint16_t val);
**         strcatNum16s            - void Utility_strcatNum16s(uint8_t *dst, size_t dstSize, int16_t val);
**         strcatNum32u            - void Utility_strcatNum32u(uint8_t *dst, size_t dstSize, uint32_t val);
**         strcatNum32s            - void Utility_strcatNum32s(uint8_t *dst, size_t dstSize, long val);
**         strcatNum16uFormatted   - void Utility_strcatNum16uFormatted(uint8_t *dst, size_t dstSize, uint16_t...
**         strcatNum16sFormatted   - void Utility_strcatNum16sFormatted(uint8_t *dst, size_t dstSize, int16_t val,...
**         strcatNum32uFormatted   - void Utility_strcatNum32uFormatted(uint8_t *dst, size_t dstSize, uint32_t...
**         strcatNum32sFormatted   - void Utility_strcatNum32sFormatted(uint8_t *dst, size_t dstSize, long val,...
...
**         strcatNum24Hex          - void Utility_strcatNum24Hex(uint8_t *dst, size_t dstSize, uint32_t num);
**         strcatNum32Hex          - void Utility_strcatNum32Hex(uint8_t *dst, size_t dstSize, uint32_t num);
**         strcatNum32sDotValue100 - void Utility_strcatNum32sDotValue100(uint8_t *dst, size_t dstSize, long num);
**         IsLeapYear              - bool Utility_IsLeapYear(uint16_t year);
**         WeekDay                 - uint8_t Utility_WeekDay(uint16_t year, uint8_t month, uint8_t day);
**         ReadEscapedName         - uint8_t Utility_ReadEscapedName(const unsigned char *filename, uint8_t...
**         xatoi                   - uint8_t Utility_xatoi(const unsigned char **str, int32_t *res);
**         ScanDate                - uint8_t Utility_ScanDate(const unsigned char **str, uint8_t *day, uint8_t...
**         ScanTime                - uint8_t Utility_ScanTime(const unsigned char **str, uint8_t *hour, uint8_t...
**         ScanDecimal8uNumber     - uint8_t Utility_ScanDecimal8uNumber(const unsigned char **str, uint8_t *val);
**         ScanDecimal8sNumber     - uint8_t Utility_ScanDecimal8sNumber(const unsigned char **str, signed char...
**         ScanDecimal16uNumber    - uint8_t Utility_ScanDecimal16uNumber(const unsigned char **str, uint16_t *val);
**         ScanDecimal16sNumber    - uint8_t Utility_ScanDecimal16sNumber(const unsigned char **str, int16_t *val);
**         ScanDecimal32uNumber    - uint8_t Utility_ScanDecimal32uNumber(const unsigned char **str, uint32_t *val);
**         ScanDecimal32sNumber    - uint8_t Utility_ScanDecimal32sNumber(const unsigned char **str, uint32_t *val);
**         ScanHex8uNumber         - uint8_t Utility_ScanHex8uNumber(const unsigned char **str, uint8_t *val);
**         ScanHex8uNumberNoPrefix - uint8_t Utility_ScanHex8uNumberNoPrefix(const unsigned char **str, uint8_t...
**         ScanHex16uNumber        - uint8_t Utility_ScanHex16uNumber(const unsigned char **str, uint16_t *val);
**         ScanHex32uNumber        - uint8_t Utility_ScanHex32uNumber(const unsigned char **str, uint32_t *val);
**         strcmp                  - int16_t Utility_strcmp(const char *, const char *);
**         strncmp                 - int16_t Utility_strncmp(const char *, const char *, size_t size);
**         strFind                 - int16_t Utility_strFind(uint8_t *str, uint8_t *subStr);
**         strtailcmp              - uint8_t Utility_strtailcmp(uint8_t *str, uint8_t *tail);
**         strlen                  - uint16_t Utility_strlen(const char *);
**         strCutTail              - uint8_t Utility_strCutTail(uint8_t *str, uint8_t *tail);
**
...
/*
** ===================================================================
**     Method      :  Utility_Num8uToStr (component Utility)
**     Description :
 ...
 */
void Utility_Num8uToStr(uint8_t *dst, size_t dstSize, uint8_t val)
{
  Utility_Num16uToStr(dst, dstSize, (uint16_t)val);
}

/*
** ===================================================================
**     Method      :  Utility_Num8sToStr (component Utility)
**     Description :
 ...
 */
void Utility_Num8sToStr(uint8_t *dst, size_t dstSize, signed char val)
{
  Utility_Num16sToStr(dst, dstSize, (int16_t)val);
}
...
/*
** ===================================================================
**     Method      :  Utility_Num16sToStr (component Utility)
**     Description :
**         Converts a signed 16bit value into a string.
**     Parameters  :
**         NAME            - DESCRIPTION
 ...
 */
void Utility_Num16sToStr(uint8_t *dst, size_t dstSize, int16_t val)
{
  unsigned char *ptr =  ((unsigned char *)dst);
  unsigned char i=0, j;
  unsigned char tmp;
  ...
  if (val==(int16_t)(0x8000)) { /* special case 0x8000/-32768: prevent overflow below. */
    Utility_strcpy(dst, dstSize, (unsigned char*)"-32768");
    return;
  }
  dstSize--; /* for zero uint8_t */
  if (sign) {
...
/*
** ===================================================================
**     Method      :  Utility_Num16sToStrFormatted (component Utility)
**     Description :
...
*/
void Utility_Num16sToStrFormatted(uint8_t *dst, size_t dstSize, int16_t val, char fill, uint8_t nofFill)
{
  Utility_Num16sToStr(dst, dstSize, val);
  ShiftRightAndFill(dst, fill, nofFill);
}

/*
** ===================================================================
**     Method      :  Utility_Num16uToStrFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Size for the format (right aligned) string, e.g. '2' for "%2d"
*/
void Utility_Num16uToStrFormatted(uint8_t *dst, size_t dstSize, uint16_t val, char fill, uint8_t nofFill)
{
  Utility_Num16uToStr(dst, dstSize, val);
  ShiftRightAndFill(dst, fill, nofFill);
}

/*
** ===================================================================
**     Method      :  Utility_Num32uToStrFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Size for the format (right aligned) string, e.g. '2' for "%2d"
*/
void Utility_Num32uToStrFormatted(uint8_t *dst, size_t dstSize, uint32_t val, char fill, uint8_t nofFill)
{
  Utility_Num32uToStr(dst, dstSize, val);
  ShiftRightAndFill(dst, fill, nofFill);
}

/*
** ===================================================================
**     Method      :  Utility_Num32sToStrFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Size for the format (right aligned) string, e.g. '2' for "%2d"
*/
void Utility_Num32sToStrFormatted(uint8_t *dst, size_t dstSize, long val, char fill, uint8_t nofFill)
{
  Utility_Num32sToStr(dst, dstSize, val);
  ShiftRightAndFill(dst, fill, nofFill);
}

/*
** ===================================================================
**     Method      :  Utility_strcatNum8u (component Utility)
**     Description :
...
/*!
  ...
  */
void Utility_strcatNum8u(uint8_t *dst, size_t dstSize, uint8_t val)
{
  unsigned char buf[sizeof("256")]; /* maximum buffer size we need */

  Utility_Num8uToStr(buf, sizeof(buf), val);
  Utility_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  Utility_strcatNum8s (component Utility)
**     Description :
...
/*!
  ...
  */
void Utility_strcatNum8s(uint8_t *dst, size_t dstSize, signed char val)
{
  unsigned char buf[sizeof("-128")]; /* maximum buffer size we need */

  Utility_Num8sToStr(buf, sizeof(buf), val);
  Utility_strcat(dst, dstSize, buf);
}
...
/*
** ===================================================================
**     Method      :  Utility_strcatNum16s (component Utility)
**     Description :
...
/*!
  ...
  \param[in] val The 16bit signed number to add
  */
void Utility_strcatNum16s(uint8_t *dst, size_t dstSize, int16_t val)
{
  unsigned char buf[sizeof("-32768")]; /* maximum buffer size we need */

  Utility_Num16sToStr(buf, sizeof(buf), val);
  Utility_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  Utility_strcatNum16uFormatted (component Utility)
**     Description :
...
/*!
  ...
  */
void Utility_strcatNum16uFormatted(uint8_t *dst, size_t dstSize, uint16_t val, char fill, uint8_t nofFill)
{
  unsigned char buf[sizeof("32768")]; /* maximum buffer size we need */

  Utility_Num16uToStrFormatted(buf, dstSize, val, fill, nofFill);
  Utility_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  Utility_strcatNum16sFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Number of fill characters
  */
void Utility_strcatNum16sFormatted(uint8_t *dst, size_t dstSize, int16_t val, char fill, uint8_t nofFill)
{
  unsigned char buf[sizeof("-32768")]; /* maximum buffer size we need */

  Utility_Num16sToStrFormatted(buf, dstSize, val, fill, nofFill);
  Utility_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  Utility_strcatNum32uFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Number of fill characters
  */
void Utility_strcatNum32uFormatted(uint8_t *dst, size_t dstSize, uint32_t val, char fill, uint8_t nofFill)
{
  unsigned char buf[sizeof("4294967295")]; /* maximum buffer size we need */

  Utility_Num32uToStrFormatted(buf, dstSize, val, fill, nofFill);
  Utility_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  Utility_strcatNum32sFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Number of fill characters
  */
void Utility_strcatNum32sFormatted(uint8_t *dst, size_t dstSize, long val, char fill, uint8_t nofFill)
{
  unsigned char buf[sizeof("-4294967295")]; /* maximum buffer size we need */

  Utility_Num32sToStrFormatted(buf, dstSize, val, fill, nofFill);
  Utility_strcat(dst, dstSize, buf);
}
...
/*
** ===================================================================
**     Method      :  Utility_strcatNum24Hex (component Utility)
**     Description :
...
/*!
  ...
  */
void Utility_strcatNum24Hex(uint8_t *dst, size_t dstSize, uint32_t num)
{
...
/*
** ===================================================================
**     Method      :  Utility_strcatNum32Hex (component Utility)
**     Description :
**         Appends a 16bit unsigned value to a buffer as hex number
**         (without a 0x prefix).
**     Parameters  :
...
/*!
  ...
  */
void Utility_strcatNum32Hex(uint8_t *dst, size_t dstSize, uint32_t num)
{
...
/*
** ===================================================================
**     Method      :  Utility_strcatNum32s (component Utility)
**     Description :
...
/*!
  ...
  */
void Utility_strcatNum32s(uint8_t *dst, size_t dstSize, long val)
{
  unsigned char buf[sizeof("-4294967295")]; /* maximum buffer size we need */

  Utility_Num32sToStr(buf, sizeof(buf), val);
  Utility_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  Utility_strcatNum32u (component Utility)
**     Description :
**         Appends a 32bit signed value to a string buffer.
**     Parameters  :
**         NAME            - DESCRIPTION
...
/*!
  ...
  \param[in] val The 32bit unsigned number to add
  */
void Utility_strcatNum32u(uint8_t *dst, size_t dstSize, uint32_t val)
{
  unsigned char buf[sizeof("4294967295")]; /* maximum buffer size we need */

  Utility_Num32uToStr(buf, sizeof(buf), val);
  Utility_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  Utility_Num32sToStr (component Utility)
**     Description :
 ...
 */
void Utility_Num32sToStr(uint8_t *dst, size_t dstSize, long val)
{
  unsigned char *ptr = ((unsigned char *)dst);
  unsigned char i=0, j;
  unsigned char tmp;
  ...
  if (val==(int32_t)(0x80000000)) { /* special case 0x80000000/-2147483648: prevent overflow below. */
    Utility_strcpy(dst, dstSize, (unsigned char*)"-2147483648");
    return;
  }
  dstSize--; /* for zero uint8_t */
  if (sign) {
...
/*
** ===================================================================
**     Method      :  Utility_Num32uToStr (component Utility)
**     Description :
 ...
 */
void Utility_Num32uToStr(uint8_t *dst, size_t dstSize, uint32_t val)
{
  unsigned char *ptr = ((unsigned char *)dst);
  unsigned char i=0, j;
  unsigned char tmp;
...
/*
** ===================================================================
**     Method      :  Utility_IsLeapYear (component Utility)
**     Description :
...
** ===================================================================
*/
bool Utility_IsLeapYear(uint16_t year)
{
...
/*
** ===================================================================
**     Method      :  Utility_WeekDay (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_WeekDay(uint16_t year, uint8_t month, uint8_t day)
{
  ...
  sum += sum/4;
  sum %= 7;
  if (Utility_IsLeapYear(year) && (month==1 || month==2)) {
    sum--;
  }
  sum += day;
  sum %= 7;
...
/*
** ===================================================================
**     Method      :  Utility_ReadEscapedName (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ReadEscapedName(const unsigned char *filename, uint8_t *destname, size_t maxlen, size_t *lenRead, size_t *lenWritten, const char *terminators)
{
...
/*
** ===================================================================
**     Method      :  Utility_xatoi (component Utility)
**     Description :
...
#endif
uint8_t Utility_xatoi(const unsigned char **str, int32_t *res)
{
...
/*
** ===================================================================
**     Method      :  Utility_ScanDate (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanDate(const unsigned char **str, uint8_t *day, uint8_t *month, uint16_t *year)
{
  ...
  if (   Utility_ScanDecimal8uNumber(&p, day)==ERR_OK
      && *day > 0 && *day <= 31
      && (*p=='.' || *p=='-')
     )
  {
    p++;
    if (   Utility_ScanDecimal8uNumber(&p, month)==ERR_OK
        && *month > 0 && *month <= 12
        && (*p=='.' || *p=='-')
       )
    {
      p++;
      if (   Utility_ScanDecimal16uNumber(&p, year)==ERR_OK
...
/*
** ===================================================================
**     Method      :  Utility_ScanTime (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanTime(const unsigned char **str, uint8_t *hour, uint8_t *minute, uint8_t *second, uint8_t *hSecond)
{
  ...
  *hSecond = 0;
  ...
  if (   Utility_ScanDecimal8uNumber(&p, hour)==ERR_OK
      && *hour <= 24
      && *p==':'
     )
  {
    p++; /* skip ':' */
    if (   Utility_ScanDecimal8uNumber(&p, minute)==ERR_OK
        && *minute <= 60
       )
    {
      if (*p==':') { /* there is more after the minute */
        p++; /* skip ':' */
        if (   Utility_ScanDecimal8uNumber(&p, second)==ERR_OK
            && *second <= 60
           )
        {
...
/*
** ===================================================================
**     Method      :  Utility_ScanDecimal8uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanDecimal8uNumber(const unsigned char **str, uint8_t *val)
{
...
/*
** ===================================================================
**     Method      :  Utility_ScanDecimal8sNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanDecimal8sNumber(const unsigned char **str, signed char *val)
{
  ...
  *val = 0;
  ...
  res = Utility_ScanDecimal8uNumber(&p, &val8u);
  if (res != ERR_OK) {
    return res;
  }
  if (isNeg) {
...
/*
** ===================================================================
**     Method      :  Utility_ScanDecimal16uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanDecimal16uNumber(const unsigned char **str, uint16_t *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
/*
** ===================================================================
**     Method      :  Utility_ScanDecimal16sNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanDecimal16sNumber(const unsigned char **str, int16_t *val)
{
  /* Scans a decimal number, and stops at any non-number. Number can have any preceding spaces. */
  const unsigned char *p = *str;
  bool isNeg;
  ...
  *val = 0;
  ...
  res = Utility_ScanDecimal16uNumber(&p, (uint16_t*)&val16u);
  if (res != ERR_OK) {
    return res;
  }
  if (isNeg) {
...
/*
** ===================================================================
**     Method      :  Utility_ScanDecimal32uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanDecimal32uNumber(const unsigned char **str, uint32_t *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
/*
** ===================================================================
**     Method      :  Utility_ScanDecimal32sNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanDecimal32sNumber(const unsigned char **str, uint32_t *val)
{
  /* Scans a decimal number, and stops at any non-number. Number can have any preceding spaces. */
  const unsigned char *p = *str;
  bool isNeg;
  ...
  *val = 0;
  ...
  res = Utility_ScanDecimal32uNumber(&p, &val32u);
  if (res != ERR_OK) {
    return res;
  }
  if (isNeg) {
...
/*
** ===================================================================
**     Method      :  Utility_strcmp (component Utility)
**     Description :
...
*/
/***
int16_t Utility_strcmp(const char *, const char *)
{
...
/*
** ===================================================================
**     Method      :  Utility_strncmp (component Utility)
**     Description :
...
*/
/***
int16_t Utility_strncmp(const char *, const char *, size_t size)
{
...
/*
** ===================================================================
**     Method      :  Utility_strlen (component Utility)
**     Description :
...
*/
/***
uint16_t Utility_strlen(const char *)
{
...
/*
** ===================================================================
**     Method      :  Utility_ScanHex32uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanHex32uNumber(const unsigned char **str, uint32_t *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
/*
** ===================================================================
**     Method      :  Utility_ScanHex16uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanHex16uNumber(const unsigned char **str, uint16_t *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
/*
** ===================================================================
**     Method      :  Utility_ScanHex8uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanHex8uNumber(const unsigned char **str, uint8_t *val)
{
...
/*
** ===================================================================
**     Method      :  Utility_ScanHex8uNumberNoPrefix (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanHex8uNumberNoPrefix(const unsigned char **str, uint8_t *val)
{
...
/*
** ===================================================================
**     Method      :  Utility_strtailcmp (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_strtailcmp(uint8_t *str, uint8_t *tail)
{
  int i, j;

  i = (int)Utility_strlen((char*)str);
  j = (int)Utility_strlen((char*)tail);
...
/*
** ===================================================================
**     Method      :  Utility_strCutTail (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_strCutTail(uint8_t *str, uint8_t *tail)
{
  /* cut the tail from the string */
  size_t strLen, tailLen;

  if (Utility_strtailcmp(str, tail)!=0) { /* check if tail is present */
    return ERR_FAILED; /* tail not found */
  }
  tailLen = Utility_strlen((char*)tail);
  strLen = Utility_strlen((char*)str);
...
/*
** ===================================================================
**     Method      :  Utility_strcatNum32sDotValue100 (component Utility)
**     Description :
...
** ===================================================================
*/
void Utility_strcatNum32sDotValue100(uint8_t *dst, size_t dstSize, long num)
{
  Utility_strcatNum32s(dst, dstSize, num/100);
  Utility_chcat(dst, dstSize, '.');
  if (num<0) {
    num = -num;
  }
  Utility_strcatNum16uFormatted(dst, dstSize, (uint16_t)(num%100), '0', 2);
}

/*
** ===================================================================
**     Method      :  Utility_strFind (component Utility)
**     Description :
...
** ===================================================================
*/
int16_t Utility_strFind(uint8_t *str, uint8_t *subStr)
{
  int16_t i, len;

  len = (int16_t)Utility_strlen((char*)subStr);
  for (i=0; *str!='\0'; i++, str++) {
    if (Utility_strncmp((char*)str, (char*)subStr, len)==0) {
      return i; /* found */
    }
  }
  return -1; /* not found */
